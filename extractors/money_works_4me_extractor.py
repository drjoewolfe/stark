...
def extract_money_works_4me(browser, stark_config, stark_input):
    extracts = {}
    for stock_info_request in stark_input["stock_info_requests"]:
        symbol = stock_info_request["symbol"]
        extracts[symbol] = extract_money_works_4me_for_request(browser, stock_info_request, stark_config)

    return extracts


def extract_money_works_4me_for_request(browser, stock_info_request, stark_config):
    info = None
